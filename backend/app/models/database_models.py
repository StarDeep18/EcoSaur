...
import uuid
from sqlalchemy import Column, String, Integer, Boolean, Float, DateTime, ForeignKey, Text, Table
...
class Scan(Base):
    ...
    user_id = Column(String, ForeignKey("users.id"), index=True, default="default")
