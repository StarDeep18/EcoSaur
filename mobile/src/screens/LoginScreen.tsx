...
export default function LoginScreen() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      setLoading(false);
      setErrorMsg('An unexpected connection issue occurred. Please check your internet connection.');
    }
  };
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', padding: 24 }}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 36 }}>
          ...
          <Text style={{ fontSize: 14, color: theme.muted, textAlign: 'center', marginTop: 6, paddingHorizontal: 20 }}>
            Sign in to check ingredients, track scans, and explore clean swaps.
          </Text>
        </View>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 24 }}>
          <Text style={{ color: theme.muted, fontSize: 14 }}>Don't have an account? </Text>
          <TouchableOpacity onPress={() => router.push('/register')}>
            <Text style={{ color: theme.primary, fontWeight: 'bold', fontSize: 14 }}>Sign Up</Text>
          </TouchableOpacity>
        </View>
